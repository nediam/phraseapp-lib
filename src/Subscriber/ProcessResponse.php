...
namespace nediam\PhraseApp\Subscriber;
...
use nediam\PhraseApp\ResponseLocation\JsonLocation;
...
class ProcessResponse implements SubscriberInterface
{
     ...
     */
    public function __construct(DescriptionInterface $description, array $responseLocations = [])
    {
    ...
    private function triggerBeforeVisitor($location, Parameter $model, array &$result, CommandInterface $command, ResponseInterface $response, array &$context)
    {
        ...
        $this->responseLocations[$location]->before($command, $response, $model, $result, $context);
    }
    ...
    private function visitOuterArray(Parameter $model, array &$result, CommandInterface $command, ResponseInterface $response, array &$context)
    {
